...
def train():
    ...
    test_x = ds_test.data.reshape([-1, 1, 28, 28]).numpy().astype(np.float) / 255 # normalzacija na [0,1]
    ...
    # e provjeri kojih su ti dimenzija max pool slojevi da ne bi bilo, možeš samo isrpintati njihov shape
    # a u layers.py u inicijalizaciji imaš kako se računaju dimenzije slojeva
    net = []
