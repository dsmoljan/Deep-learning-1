...
class PoolNet(nn.Module):
    ...
    def train(self, train_dataset, val_dataset, no_epochs = 10, lr = 1e-2, weight_decay = 0, batch_size = 1):
        ...
        for epoch in range(no_epochs):
            ...
            eval_loss, eval_avg_accuracy, eval_avg_precision, eval_avg_recall, eval_avg_f1, conf_matrix = self.evaluate(dataloader_val, batch_size)
            train_loss, train_avg_accuracy, train_avg_precision, train_avg_recall, train_avg_f1, conf_matrix = self.evaluate(dataloader_train, batch_size)
